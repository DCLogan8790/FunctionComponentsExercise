...
// 5a
const GrinchPoster = () => {
    return <img src=" https://img01.mgo-images.com/image/thumbnail/v2/content/1MV1ca3f097dd209568db5d4a36e429dbda.jpeg" alt="grinch" srcset=""/>
}
...
const DiceRoll = () => {
    // 8b
    const die1 = Math.random();
    const die2 = Math.random() *6;
    console.log(die1);
    return <div>
